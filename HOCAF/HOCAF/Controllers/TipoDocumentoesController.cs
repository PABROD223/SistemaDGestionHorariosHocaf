...
namespace HOCAF.Controllers
{
    public class TipoDocumentoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idDocumento,nombreDocumento")] TipoDocumento tipoDocumento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idDocumento,nombreDocumento")] TipoDocumento tipoDocumento)
        {
            if (ModelState.IsValid)
            {
