...
namespace HOCAF.Controllers
{
    public class JornadasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idJornada,nombre,estado")] Jornada jornada)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idJornada,nombre,estado")] Jornada jornada)
        {
            if (ModelState.IsValid)
            {
