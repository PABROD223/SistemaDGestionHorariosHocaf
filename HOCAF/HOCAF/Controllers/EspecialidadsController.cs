...
namespace HOCAF.Controllers
{
    public class EspecialidadsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idEspecialidad,nombre,estado")] Especialidad especialidad)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idEspecialidad,nombre,estado")] Especialidad especialidad)
        {
            if (ModelState.IsValid)
            {
